...
const regionData = {
  ...
  /* =======================
     ...
     ======================= */
  america: {
    "antigua and barbuda": { name: "Antigua y Barbuda", cap: "Saint John's", flag: "ag.png" },
    "argentina": { name: "Argentina", cap: "Buenos Aires", flag: "ar.png" },
    "bahamas": { name: "Bahamas", cap: "Nasáu", flag: "bs.png" },
    "barbados": { name: "Barbados", cap: "Bridgetown", flag: "bb.png" },
    "belize": { name: "Belice", cap: "Belmopán", flag: "bz.png" },
    ...
    "saint kitts and nevis": { name: "San Cristóbal y Nieves", cap: "Basseterre", flag: "kn.png" },
    "saint lucia": { name: "Santa Lucía", cap: "Castries", flag: "lc.png" },
    "saint vincent and the grenadines": { name: "San Vicente y las Granadinas", cap: "Kingstown", flag: "vc.png" },
  ...
  europe: {
    ...
    "luxembourg": { name: "Luxemburgo", cap: "Luxemburgo", flag: "lu.png" },
    "malta": { name: "Malta", cap: "La Valeta", flag: "mt.png" },
    "moldova": { name: "Moldavia", cap: "Chisináu", flag: "md.png" },
    "monaco": { name: "Mónaco", cap: "Mónaco", flag: "mc.png" },
    "montenegro": { name: "Montenegro", cap: "Podgorica", flag: "me.png" },
    "netherlands": { name: "Países Bajos", cap: "Ámsterdam", flag: "nl.png" },
    "north macedonia": { name: "Macedonia del Norte", cap: "Skopie", flag: "mk.png" },
    ...
    "san marino": { name: "San Marino", cap: "San Marino", flag: "sm.png" },
  ...
  africa: {
    ...
    "eritrea": { name: "Eritrea", cap: "Asmara", flag: "er.png" },
    "eswatini": { name: "Esuatini", cap: "Mbabane", flag: "sz.png" },
    "ethiopia": { name: "Etiopía", cap: "Adís Abeba", flag: "et.png" },
    "gabon": { name: "Gabón", cap: "Libreville", flag: "ga.png" },
    "gambia": { name: "Gambia", cap: "Banjul", flag: "gm.png" },
    "ghana": { name: "Ghana", cap: "Acra", flag: "gh.png" },
    "guinea": { name: "Guinea", cap: "Conakri", flag: "gn.png" },
    "guinea-bissau": { name: "Guinea-Bisáu", cap: "Bisáu", flag: "gw.png" },
    "ivory coast": { name: "Costa de Marfil", cap: "Yamusukro", flag: "ci.png" },
    "kenya": { name: "Kenia", cap: "Nairobi", flag: "ke.png" },
    "lesotho": { name: "Lesoto", cap: "Maseru", flag: "ls.png" },
    "liberia": { name: "Liberia", cap: "Monrovia", flag: "lr.png" },
    "libya": { name: "Libia", cap: "Trípoli", flag: "ly.png" },
    "madagascar": { name: "Madagascar", cap: "Antananarivo", flag: "mg.png" },
    "malawi": { name: "Malaui", cap: "Lilongüe", flag: "mw.png" },
    "mali": { name: "Malí", cap: "Bamako", flag: "ml.png" },
    "mauritania": { name: "Mauritania", cap: "Nuakchot", flag: "mr.png" },
    "mauritius": { name: "Mauricio", cap: "Port Louis", flag: "mu.png" },
    "morocco": { name: "Marruecos", cap: "Rabat", flag: "ma.png" },
    "mozambique": { name: "Mozambique", cap: "Maputo", flag: "mz.png" },
    "namibia": { name: "Namibia", cap: "Windhoek", flag: "na.png" },
    ...
    "zambia": { name: "Zambia", cap: "Lusaka", flag: "zm.png" },
    "zimbabwe": { name: "Zimbabue", cap: "Harare", flag: "zw.png" }
  },
  ...
  asia: {
    ...
    "armenia": { name: "Armenia", cap: "Ereván", flag: "am.png" },
    "azerbaijan": { name: "Azerbaiyán", cap: "Bakú", flag: "az.png" },
    "bahrain": { name: "Baréin", cap: "Manama", flag: "bh.png" },
    "bangladesh": { name: "Bangladés", cap: "Daca", flag: "bd.png" },
    "bhutan": { name: "Bután", cap: "Timbu", flag: "bt.png" },
    ...
    "qatar": { name: "Catar", cap: "Doha", flag: "qa.png" },
  ...
  oceania: {
    ...
    "kiribati": { name: "Kiribati", cap: "Tarawa", flag: "ki.png" },
    "marshall islands": { name: "Islas Marshall", cap: "Majuro", flag: "mh.png" },
    "micronesia": { name: "Micronesia", cap: "Palikir", flag: "fm.png" },
