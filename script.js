...
      "ibirama - presidente getúlio": { cap: "Presidente Getúlio" },
      "ituporanga": { cap: "Ituporanga" },
      "joinville": { cap: "Joinville" },
      "são bento do sul - rio negrinho": { cap: "São Bento do Sul" },
      "mafra": { cap: "Mafra" },
      "caçador": { cap: "Caçador" },
      "chapecó": { cap: "Chapecó" },
      "joaçaba - herval d'oeste": { cap: "Campos Novos" },
      "videira": { cap: "Videira" },
      "concórdia": { cap: "Concórdia" },
      "xanxerê": { cap: "Xanxerê" },
      "são Miguel do oeste": { cap: "São Miguel do Oeste" },
      "maravilha": { cap: "Maravilha" },
      "são Lourenço do oeste": { cap: "São Lourenço do Oeste" },
      "lages": { cap: "Lages" },
